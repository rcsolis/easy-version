...
var formatVersion = function formatVersion(version) {
  if (!version || typeof version === 'function' || _typeof(version) === 'object' || version === true) {
    return undefined;
  }

  var ver = removeWhitespaces(version.toString());
  var split = ver.split('.');
  ...
  if (split.length < MAX_VERSION_DIGITS) {
    ...
    for (var i = size; i < MAX_VERSION_DIGITS; i++) {
      ver += '.0';
    }
    ...
    if (!req || !req.headers || !req.headers.accept || req.headers.accept === undefined || typeof req.headers.accept !== 'string') {
      ...
      if (customFunction && typeof customFunction === 'function') {
        try {
          ...
          next(new Error("".concat(errors.customFunctionError, " ").concat(err.toString())));
        }
      } else {
        var acceptHeader = removeWhitespaces(req.headers.accept).replace(/\r\n\S.*$/, '');
        ...
        if (!acceptHeader || acceptHeader === undefined || acceptHeader.length !== 2) {
          ...
          var versionNumber;
          var params = acceptHeader[1].split(',');
          ...
          if (versionNumber !== undefined) {
            ...
            res.setHeader('Content-Type', "".concat(acceptHeader[0], ";version=").concat(versionNumber));
...
function routeTo(args, notVersionFound) {
  return function () {
    var _ref = _asyncToGenerator(_regeneratorRuntime().mark(function _callee(req, res, next) {
      var versions, rv, v, _i2, _versions, version;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              versions = Object.keys(args);
              rv = String(req.version);
              _i2 = 0, _versions = versions;

            case 10:
              if (!(_i2 < _versions.length)) {
                _context.next = 19;
                break;
              }

              version = _versions[_i2];
            ...
            case 23:
              _context.next = 25;
              return notVersionFound.call(this, req, res, next);
            ...
            case 27:
              _context.next = 29;
              return args[v].call(this, req, res, next);
